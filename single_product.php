...
$pdt_fetch = []; // Assuming this is populated correctly

if (isset($pdt_fetch['ctg_id']) && $pdt_fetch['ctg_id'] !== null) {
    $ctg_id = $pdt_fetch['ctg_id'];
    $rel_pro = $obj->related_product($ctg_id);
} else {
    // Handle the case where $pdt_fetch['ctg_id'] is null or not set
    // For example, you can provide a default value or skip related_product method call
    $rel_pro = []; // or some default value
}
